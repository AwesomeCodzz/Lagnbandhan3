...
class BiodataManager {
    constructor(languageManager) {
        ...
        this.googleFormUrls = {
            // Male Forms
            maratha_male: 'https://docs.google.com/forms/d/e/1FAIpQLSfhNkeS6RmaCjBX_D0IUPk1RynYYKE9NENNPNiUu9rUHIATiQ/viewform?usp=dialog',
            koli_male: 'https://docs.google.com/forms/d/e/1FAIpQLSeTeNU_1qjt9dxyITmH3jqDCwia_xetKzacCW1r7PjiGnhYKg/viewform?usp=dialog',
            teli_male: 'https://docs.google.com/forms/d/e/1FAIpQLSf3IcgxBE3TbtWQ_ObkJQUzt6IeUSffP0lvuyx7y-_BC-NU3Q/viewform?usp=dialog',
            wani_male: 'https://docs.google.com/forms/d/e/1FAIpQLSdMzwrYbdZJiAYV0J3pezPjm83u6wot2cOclZj9egKYOGPpHg/viewform?usp=dialog',
            vanjari_male: 'https://docs.google.com/forms/d/e/1FAIpQLSfPoTbKt6G0ROQrRMpFvBsag8NKKDaJ1guy83xaK9iGUpqL9w/viewform?usp=dialog',
            mali_male: 'https://docs.google.com/forms/d/e/1FAIpQLSc0AP8OE1AYsSTcY_VEvE5RbhxCoH5BxhQaA4Sdylytg4ax5A/viewform?usp=dialog',
            sonar_male: 'https://docs.google.com/forms/d/e/1FAIpQLScSQ_hVV6QpsQgJ6G2X2lBt39FXIFyv35bvtClBO-kY0aX8IQ/viewform?usp=dialog',
            shimpi_male: 'https://docs.google.com/forms/d/e/1FAIpQLSf_rGRkwLO7XTbYoAexYyMeunLTmF1NWppQ62RKoDXQwyQP2A/viewform?usp=dialog',
            jain_male: 'https://docs.google.com/forms/d/e/1FAIpQLSfuHR3dMdzonwKmCr8LiTXTHE_s3AMrojqbNHWs1o_OavaBeg/viewform?usp=dialog',
            pardeshi_male: 'https://docs.google.com/forms/d/e/1FAIpQLScqWcRkcBlD3XptSKaG3TAhKbjUQSFoLjxlWSCNfkVMwFnFAQ/viewform?usp=dialog',
            kumbhar_male: 'https://docs.google.com/forms/d/e/1FAIpQLSdwm8s1Tq7uT9szCXPOqmoFCxKmjj8j2rs4WJdecC_teO-qwQ/viewform?usp=dialog',
            rajput_male: 'https://docs.google.com/forms/d/e/1FAIpQLSc6OCPjuwUBD1mU71Ll3FlAohgPfFkkazCND3UDJU17lniqbQ/viewform?usp=dialog',
            leva_patil_male: 'https://docs.google.com/forms/d/e/1FAIpQLSds8h33wOhI2HUnSQXiCuaD2QajASs4xE8wbzMOF4xQ7hJUzw/viewform?usp=dialog',
            
            // Female Forms
            maratha_female: 'https://docs.google.com/forms/d/e/1FAIpQLScKYEmPwyd8OjEUsl4VO_e6wt7M0rU0mfK5Rng7ZBfeaAOtCA/viewform?usp=dialog',
            koli_female: 'https://docs.google.com/forms/d/e/1FAIpQLSe9kCM8PbSw7P1hsG4AkMO5TndOflyoaBpIodrGf_NRrxmJ5A/viewform?usp=dialog',
            teli_female: 'https://docs.google.com/forms/d/e/1FAIpQLSd7kA4nxTKTdNNHYOwrsFrTwKFETljVjFGDBuQpjBAkSUsNIg/viewform?usp=dialog',
            wani_female: 'https://docs.google.com/forms/d/e/1FAIpQLSeVZ8mUqF9J_sufnxsh-aSbIQhKyOC1s422MeXCnS2VWxy0EQ/viewform?usp=dialog',
            vanjari_female: 'https://docs.google.com/forms/d/e/1FAIpQLScC_kKS0mJYARwB9z0BgTxf62mDuZturbsrYtt7-nVxH8I8qw/viewform?usp=dialog',
            mali_female: 'https://docs.google.com/forms/d/e/1FAIpQLScEx2Ao1ScpD5V7GhSTaZBSDu5I3qaoQyPLVPiMxajB7dcuiQ/viewform?usp=dialog',
            sonar_female: 'https://docs.google.com/forms/d/e/1FAIpQLSeablE5ZZyIAr0JFz9VNOeN7CjFGAtMskoTVjgqwFOBAnOKBg/viewform?usp=dialog',
            shimpi_female: 'https://docs.google.com/forms/d/e/1FAIpQLSe7DCpuVftK3fcYdZwmY9ZeMd6_duD3s8zIlXV_usUeTf5ROA/viewform?usp=dialog',
            jain_female: 'https://docs.google.com/forms/d/e/1FAIpQLScByaMmT_e129xmx2RZ1R8oi80DAllOEFFhAjsfY6CZg2-t1g/viewform?usp=dialog',
            pardeshi_female: 'https://docs.google.com/forms/d/e/1FAIpQLSfGuGjD2gs-vJSrNUpbEcHQC9-r2Ad2eXl7P2FAllugigMZnQ/viewform?usp=dialog',
            kumbhar_female: 'https://docs.google.com/forms/d/e/1FAIpQLSd_N1qZfLj2WLbvWYsq9y1pXHekhJYBIuTbNnrKJmQFSF3k0g/viewform?usp=dialog',
            rajput_female: 'https://docs.google.com/forms/d/e/1FAIpQLSce9R30flMNF9qKgXlyavFScGYUOatDOMZYt1RogFMVljpAfg/viewform?usp=dialog',
            leva_patil_female: 'https://docs.google.com/forms/d/e/1FAIpQLScFIIoh-lHL0x2KALBQcJGTqhe4gFD-CD3Sun8GbvCusr20XA/viewform?usp=dialog'
        };
    ...
    setupEventListeners() {
        ...
        if (createBiodataBtn) {
            createBiodataBtn.addEventListener('click', () => this.showGenderSelection());
        }
    ...
    createWhatsAppModal() {
        const modalHTML = `
            <div id="whatsappModal" class="modal">
                <div class="modal-content">
                    <span class="close">&times;</span>
                    <h2 data-translate="sendExistingBiodata">Send Existing Biodata</h2>
                    <p data-translate="whatsappDesc">Send your biodata via WhatsApp</p>
                    
                    <div class="whatsapp-form">
                        <div class="form-group">
                            <label data-translate="phoneNumber">Phone Number</label>
                            <input type="tel" id="whatsappPhone" data-placeholder-key="phonePlaceholder" placeholder="1234567890" maxlength="10">
                        </div>
                        <div class="form-group">
                            <label data-translate="message">Message</label>
                            <textarea id="whatsappMessage" rows="4" data-placeholder-key="messagePlaceholder" 
                                placeholder="I want to send my biodata"></textarea>
                        </div>
                        <button id="sendWhatsappBtn" class="btn primary">
                            <i class="fab fa-whatsapp"></i>
                            <span data-translate="sendViaWhatsapp">Send via WhatsApp</span>
                        </button>
                    </div>
                </div>
            </div>
        ...
        const closeBtn = document.querySelector('#whatsappModal .close');
    ...
    selectGender(genderChoice) {
        ...
        console.log('Before assignment - this.selectedGender:', this.selectedGender);
        
        // Direct assignment since data attributes are already "male"/"female"
        this.selectedGender = genderChoice;
        
        console.log('✅ After assignment - this.selectedGender:', this.selectedGender);
    ...
    selectCaste(caste) {
        ...
        console.log('✅ After assignment - this.selectedCaste:', this.selectedCaste);
    ...
    redirectToGoogleForm() {
        ...
        const genderValid = this.selectedGender && (this.selectedGender === 'male' || this.selectedGender === 'female');
        const casteValid = this.selectedCaste && typeof this.selectedCaste === 'string' && this.selectedCaste.length > 0;
        ...
        if (!genderValid || !casteValid) {
            ...
            this.showError(`Validation failed. Gender: ${this.selectedGender} (${genderValid ? 'valid' : 'invalid'}), Caste: ${this.selectedCaste} (${casteValid ? 'valid' : 'invalid'})`);
            return;
        }
        ...
        if (formUrl.includes('YOUR_') && formUrl.includes('_FORM_ID')) {
            this.showError('Google Form URLs need to be configured. Please update the form URLs in biodata.js');
            console.error('Placeholder URL detected. Please replace with actual Google Form URLs.');
            return;
        }
        ...
        console.log(`Redirecting to: ${this.selectedCaste} ${this.selectedGender} form`);
    ...
    getCurrentSelections() {
        return {
            ...
            formKey: this.selectedGender && this.selectedCaste ? 
                `${this.selectedCaste}_${this.selectedGender}` : null
        };
    }
